...
package com.configure_me_yolken_test_13b.api.client.okhttp

import com.configure_me_yolken_test_13b.api.client.YolkenTest13bClientAsync
import com.configure_me_yolken_test_13b.api.client.YolkenTest13bClientAsyncImpl
import com.configure_me_yolken_test_13b.api.core.ClientOptions
import com.configure_me_yolken_test_13b.api.core.Sleeper
import com.configure_me_yolken_test_13b.api.core.Timeout
import com.configure_me_yolken_test_13b.api.core.http.Headers
import com.configure_me_yolken_test_13b.api.core.http.HttpClient
import com.configure_me_yolken_test_13b.api.core.http.QueryParams
import com.configure_me_yolken_test_13b.api.core.jsonMapper
...
/**
 * A class that allows building an instance of [YolkenTest13bClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest13bOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest13bClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest13bClientAsync = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest13bOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_yolken_test_13b.api.core.jsonMapper]. The default is
        ...
        /**
         * Returns an immutable instance of [YolkenTest13bClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest13bClientAsync =
            YolkenTest13bClientAsyncImpl(
                clientOptions
                    .httpClient(
