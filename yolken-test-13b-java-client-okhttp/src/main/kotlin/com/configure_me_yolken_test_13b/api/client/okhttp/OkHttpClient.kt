...
import com.configure_me_yolken_test_13b.api.core.http.HttpRequestBody
import com.configure_me_yolken_test_13b.api.core.http.HttpResponse
import com.configure_me_yolken_test_13b.api.errors.YolkenTest13bIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw YolkenTest13bIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(YolkenTest13bIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("YOLKEN_TEST_13B_LOG")?.lowercase()) {
