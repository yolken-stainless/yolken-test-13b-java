...
import com.configure_me_yolken_test_13b.api.client.YolkenTest13bClientImpl
...
/**
 * A class that allows building an instance of [YolkenTest13bClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest13bOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest13bClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest13bClient = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest13bOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [YolkenTest13bClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest13bClient =
            YolkenTest13bClientImpl(
                clientOptions
                    .httpClient(
