...
/**
 * A client for interacting with the Yolken Test 13b REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface YolkenTest13bClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): YolkenTest13bClientAsync
    ...
    /**
     * A view of [YolkenTest13bClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
