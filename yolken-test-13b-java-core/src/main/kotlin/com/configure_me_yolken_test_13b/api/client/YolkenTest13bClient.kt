...
/**
 * A client for interacting with the Yolken Test 13b REST API synchronously. You can also switch to
...
interface YolkenTest13bClient {
     ...
     * this client.
     */
    fun async(): YolkenTest13bClientAsync
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): YolkenTest13bClient
    ...
    /**
     * A view of [YolkenTest13bClient] that provides access to raw HTTP responses for each method.
     */
