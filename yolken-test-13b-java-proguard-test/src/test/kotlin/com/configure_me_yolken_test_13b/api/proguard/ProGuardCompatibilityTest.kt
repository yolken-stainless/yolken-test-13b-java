...
package com.configure_me_yolken_test_13b.api.proguard
...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream(
                "META-INF/proguard/yolken-test-13b-java-core.pro"
            )
    ...
    @Test
    fun client() {
        val client = YolkenTest13bOkHttpClient.builder().apiKey("My API Key").build()
